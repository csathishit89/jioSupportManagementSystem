...
def createClientQuery(st, addClientQuery, userID, categoryListFetch):
    ...
    col1, col2, col3, col4 = st.columns([0.8, 5, 5, 5])
    with col2:
    ...
    with col2:  
        ...
        if newQuerysubmit:
            if category[0]==None:
                ...
                isClientNewQueryInserted = addClientQuery.addClientQuery(emailID, mobileNumber, queryHeading, queryDescription, userID, category[0])
