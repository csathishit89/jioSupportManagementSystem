...
CSV_FILE_PATH = r"C:\MAMP\htdocs\clientQueryManagement\clientEnv\Scripts\user_queries.csv"
TABLE_NAME = "queries"
...
def insert_data_from_csv(csv_path, table_name):
    ...
    try:
        ...
        insert_query = f"""
            INSERT INTO {table_name} (mailid, mobilenumber, queryheading, querydescription, status, querycreatedtime)
        ...
        with open(csv_path, 'r', newline='') as file:
            ...
            for row in reader:
                row_data = (row[1], row[2], row[3], row[4], 'Open')
