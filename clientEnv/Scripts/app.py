...
if st.session_state['logged_in'] == True:
    ...
    if user_role!='null' and user_role!='undefined' and user_role!=None:
        ...
        if st.session_state['current_page'] == 'Dashboard':
            ...
            loadSideBar.loadSideBar(st, navigationLink, streamlit_js_eval)
            if user_role == 'Client':
                clientQuery.clientQuery(st, user_id, clientQueriesFetch, categoryListFetch)
            elif user_role == 'Support':
                supportQueryList.supportQueryList(st, updateQueryStatus, pd, clientQueriesListFetch, clientHistoryQueriesListFetch, categoryListFetch)
        elif st.session_state['current_page'] == 'CreateQuery':
            loadSideBar.loadSideBar(st, navigationLink, streamlit_js_eval)
            createClientQuery.createClientQuery(st, addClientQuery, user_id, categoryListFetch)
    else:
